...
/**
 * This class stands for AgeCategory StructType
 * @subpackage Structs
 */
class AgeCategory extends AbstractStructBase
{
    /**
     * The Quantity
     * @var int
    ...
    /**
     * Constructor method for AgeCategory
     * @uses AgeCategory::setQuantity()
     * @uses AgeCategory::setOtherType()
     * @uses AgeCategory::setOntologyRefID()
     * @param int $quantity
     ...
     * Set Quantity value
     * @param int $quantity
     * @return \Ammonkc\Otaehi\StructType\AgeCategory
     */
