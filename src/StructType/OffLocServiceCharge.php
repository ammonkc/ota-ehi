...
/**
 * This class stands for OffLocServiceCharge StructType
 * @subpackage Structs
 */
class OffLocServiceCharge extends AbstractStructBase
{
    /**
     * The Vehicles
    ...
    public $Vehicles;
    /**
     * Constructor method for OffLocServiceCharge
     * @uses OffLocServiceCharge::setVehicles()
     ...
     * Set Vehicles value
     * @param \Ammonkc\Otaehi\StructType\Vehicles $vehicles
     * @return \Ammonkc\Otaehi\StructType\OffLocServiceCharge
     */
