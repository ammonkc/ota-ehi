...
/**
 * This class stands for PaymentStatus StructType
 * @subpackage Structs
 */
class PaymentStatus extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for PaymentStatus
     * @uses PaymentStatus::setOtherType()
     * @uses PaymentStatus::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\PaymentStatus
     */
