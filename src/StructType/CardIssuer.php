...
/**
 * This class stands for CardIssuer StructType
 * @subpackage Structs
 */
class CardIssuer extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for CardIssuer
     * @uses CardIssuer::setOtherType()
     * @uses CardIssuer::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\CardIssuer
     */
