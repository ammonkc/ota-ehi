...
/**
 * This class stands for Class StructType
 * @subpackage Structs
 */
class _Class extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
     ...
     * @uses _Class::setOtherType()
     * @uses _Class::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\_Class
     */
