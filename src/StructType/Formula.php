...
/**
 * This class stands for Formula StructType
 * @subpackage Structs
 */
class Formula extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for Formula
     * @uses Formula::setOtherType()
     * @uses Formula::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \ammonkc\otaehi\StructType\Formula
     */
