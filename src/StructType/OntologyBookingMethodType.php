...
/**
 * This class stands for OntologyBookingMethodType StructType
 * @subpackage Structs
 */
class OntologyBookingMethodType extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for OntologyBookingMethodType
     * @uses OntologyBookingMethodType::setOtherType()
     * @uses OntologyBookingMethodType::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \ammonkc\otaehi\StructType\OntologyBookingMethodType
     */
