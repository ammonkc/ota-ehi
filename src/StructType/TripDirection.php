...
/**
 * This class stands for TripDirection StructType
 * @subpackage Structs
 */
class TripDirection extends AbstractStructBase
{
    /**
     * The OntologyRefID
     * @var string
    ...
    /**
     * Constructor method for TripDirection
     * @uses TripDirection::setOntologyRefID()
     ...
     * @param string $ontologyRefID
     * @return \Ammonkc\Otaehi\StructType\TripDirection
     */
