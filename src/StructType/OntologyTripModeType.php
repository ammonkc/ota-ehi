...
/**
 * This class stands for OntologyTripModeType StructType
 * @subpackage Structs
 */
class OntologyTripModeType extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for OntologyTripModeType
     * @uses OntologyTripModeType::setOtherType()
     * @uses OntologyTripModeType::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\OntologyTripModeType
     */
