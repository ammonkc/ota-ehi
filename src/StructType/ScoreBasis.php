...
/**
 * This class stands for ScoreBasis StructType
 * @subpackage Structs
 */
class ScoreBasis extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for ScoreBasis
     * @uses ScoreBasis::setOtherType()
     * @uses ScoreBasis::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\ScoreBasis
     */
