...
/**
 * This class stands for Sector StructType
 * @subpackage Structs
 */
class Sector extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for Sector
     * @uses Sector::setOtherType()
     * @uses Sector::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\Sector
     */
