...
/**
 * This class stands for PropertyClass StructType
 * @subpackage Structs
 */
class PropertyClass extends AbstractStructBase
{
    /**
     * The OtherType
     * @var string
    ...
    /**
     * Constructor method for PropertyClass
     * @uses PropertyClass::setOtherType()
     * @uses PropertyClass::setOntologyRefID()
     ...
     * Set OtherType value
     * @param string $otherType
     * @return \Ammonkc\Otaehi\StructType\PropertyClass
     */
